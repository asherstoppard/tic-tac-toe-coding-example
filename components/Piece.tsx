...
export const Piece: FC<IPieceProps> = ({ isHighlighted, pieceId }) => {
  const pieces: ReactElement[] = [
    <Piece1 fill={isHighlighted ? 'white' : '#00cd97'} />,
    <Piece2 fill={isHighlighted ? 'white' : '#9f5ffe'} />
  ]
